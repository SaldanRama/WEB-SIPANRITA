        ...
        <div className="container py-4">
          <div className="row mt-3">
            <div className="col-md-4 px-5 text-white">
              ...
              />
              <h5 className="fw-bold mb-2">Fakultas Matematika dan Ilmu Pengetahuan Alam</h5>
            ...
            <div className="col-12 px-5 text-white">
              ...
              <div className="d-flex justify-content-between align-items-center">
                ...
                <div className="d-flex gap-3">
                  ...
                  <a href="https://www.youtube.com/@fakultasmipaunhas1937" className="text-white" target="_blank" rel="noopener noreferrer">
